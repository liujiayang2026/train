...
- Candidate materials: `process/legacy-package/question-2/`.
- Final-paper support snapshot: `process/legacy-package/project2_lunwen/project2_v7/support/`.
- No route is marked adopted at intake stage.
