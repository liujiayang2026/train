...
The cleaned pre-V3 project is preserved unchanged in `legacy-package/`. Question README files point to relevant legacy candidates. These pointers are intake metadata, not final route decisions.
