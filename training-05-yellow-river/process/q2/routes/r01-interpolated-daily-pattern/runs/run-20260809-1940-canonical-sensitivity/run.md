...
- 日期时间：2026-08-09 19:40 +08:00
- 执行目录：`F:\train`
- 执行命令：`python training-05-yellow-river/process/q2/routes/r01-interpolated-daily-pattern/code/analyze_question2.py --input training-05-yellow-river/process/q1/routes/r01-log-linear-sediment/runs/run-20260809-0000-imported-legacy/results/data/processed/cleaned_hydro_timeseries.csv --run-dir training-05-yellow-river/process/q2/routes/r01-interpolated-daily-pattern/runs/run-20260809-1940-canonical-sensitivity`
...
- 输入文件：`process/q1/routes/r01-log-linear-sediment/runs/run-20260809-0000-imported-legacy/results/data/processed/cleaned_hydro_timeseries.csv`；SHA-256 `0f29574dbd3adeee954da4435213f8b11c184b82073e0fd85793340c549ea05e`
...
- 是否成功完成：yes
- 异常与备注：2026-08-09 19:51 +08:00 成功完成，生成 2192 个完整日记录和 11 个达到基准阈值的突变候选。三种插值口径相对基准的六年总排沙量最大绝对差异约 0.04%；27 组突变参数对基准事件的 ±7 日覆盖率中位数为 63.6%；10 组插值/时间子区间与序列组合的频谱主峰均位于 300—450 日。保留 imported-legacy run；本运行不构成人工采用决定。输入来自 q1 历史运行，是因为它是执行时仓库内已存在的清洗机器结果；其上游验证边界仍须继承。
