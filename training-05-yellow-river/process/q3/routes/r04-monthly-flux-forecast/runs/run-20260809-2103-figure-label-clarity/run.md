...
- 日期时间：2026-08-09 21:03 +08:00
- 执行目录：`training-05-yellow-river/process/q3/routes/r04-monthly-flux-forecast/`
- 执行命令：`python code/monthly_flux_forecast.py --run-dir runs/run-20260809-2103-figure-label-clarity --q1-series ../../../q1/routes/r01-log-linear-sediment/runs/run-20260809-2032-time-block-bootstrap/results/data/cleaned_hydro_timeseries.csv --q2-daily ../../../q2/routes/r01-interpolated-daily-pattern/runs/run-20260809-2036-time-block-q1/results/data/processed/daily_flux_series.csv --q2-events ../../../q2/routes/r01-interpolated-daily-pattern/runs/run-20260809-2036-time-block-q1/results/tables/abrupt_change_events.csv`
- 代码入口/版本：`code/monthly_flux_forecast.py`；执行前 SHA-256 `84875347838E2492F48972CAF76E48B2858EBCFD24FC6CCD475C362A77AA5280`
...
- 关键参数：积分存档 72 个月；有效建模 48 个月（2018—2021）；2019—2020 扩展窗口回测选模；2018—2020 训练、2021 预测模型层条件留出；2019—2021 经验区间 80% 和 95%；2023 年对数区间扩宽系数 1.25
...
- 是否成功完成：yes
- 异常与备注：2026-08-09 21:04 +08:00 成功完成；9/9 质量检查通过。2022 年预测水量 458.39 亿 m³、输沙量 34164.05 万吨，2023 年分别为 483.88 亿 m³、37734.75 万吨，旧启发式计划仍为 474 个采样时次。与 `run-20260809-2040-time-block-upstream` 对比，11 个结果/验证文件逐字节一致；变化仅限图中证据角色、预测起点、坐标轴与风险图例。显式绑定 q1 2032 与 q2 2036 成功 run，不覆盖历史证据，也不构成人工 adopted 决定。
