...
Adjacent calendar months are coupled in the MILP through threshold-transition variables, so month-start comparisons and follow-up visits crossing month/year boundaries are included before policy selection.
...
| month | risk_level | previous_trigger_threshold | base_interval_days | trigger_threshold | cost_units | water_wape | sediment_wape | event_capture_rate |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1.000 | low | 2.500 | 14.000 | 2.500 | 15.000 | 0.059 | 0.132 | nan |
| 2.000 | low | 2.500 | 14.000 | 2.500 | 11.667 | 0.102 | 0.293 | nan |
| 3.000 | low | 2.500 | 14.000 | 2.500 | 15.000 | 0.053 | 0.137 | nan |
| 4.000 | medium | 2.500 | 10.000 | 1.500 | 15.000 | 0.068 | 0.178 | nan |
| 5.000 | medium | 1.500 | 10.000 | 1.500 | 20.000 | 0.039 | 0.095 | nan |
| 6.000 | high | 1.500 | 5.000 | 2.500 | 38.333 | 0.043 | 0.114 | 1.000 |
| 7.000 | high | 2.500 | 5.000 | 2.500 | 43.333 | 0.062 | 0.107 | 0.000 |
| 8.000 | high | 2.500 | 5.000 | 2.500 | 56.667 | 0.076 | 0.149 | 1.000 |
| 9.000 | high | 2.500 | 5.000 | 2.500 | 46.667 | 0.064 | 0.117 | 1.000 |
| 10.000 | high | 2.500 | 5.000 | 2.000 | 43.333 | 0.051 | 0.117 | 1.000 |
| 11.000 | medium | 2.000 | 10.000 | 2.000 | 23.333 | 0.067 | 0.165 | nan |
| 12.000 | low | 2.000 | 14.000 | 2.500 | 20.000 | 0.097 | 0.209 | nan |

## Calibration aggregate

- Annual expected cost: 348.33 resource units
- Water proxy WAPE: 6.18%
- Sediment proxy WAPE: 12.46%
...
| --- | --- | --- | --- | --- | --- | --- |
| optimized_dynamic | 380.000 | 76.000 | 0.055 | 0.130 | 1.000 | 14.000 |
...
| uniform_7d | 295.000 | 59.000 | 0.107 | 0.296 | 0.400 | 7.000 |
| uniform_10d | 215.000 | 43.000 | 0.143 | 0.296 | 0.800 | 10.000 |
| uniform_14d | 175.000 | 35.000 | 0.129 | 0.274 | 0.400 | 14.000 |
...
The old-r04 historical baseline uses the conservative maximum risk assigned to each calendar month across the supplied 2022 and 2023 r04 strategy. Its replay cost is therefore not the same quantity as the actual two-year average old-r04 schedule cost used in the future cost comparison.
...
| --- | --- | --- | --- | --- | --- | --- |
| calibration_2018_2020 | optimized_dynamic | 348.333 | 0.062 | 0.125 | 0.800 | 0.000 |
| calibration_2018_2020 | optimized_base_only_ablation | 271.667 | 0.081 | 0.170 | 0.200 | -76.667 |
| strategy_conditional_holdout_2021 | optimized_dynamic | 380.000 | 0.055 | 0.130 | 1.000 | 0.000 |
| strategy_conditional_holdout_2021 | optimized_base_only_ablation | 270.000 | 0.087 | 0.190 | 0.800 | -110.000 |

## Continuous-calendar boundary accounting

| split | policy | calendar_boundary_comparisons | cross_month_trigger_actions | cross_month_trigger_visits |
| --- | --- | --- | --- | --- |
| calibration_2018_2020 | optimized_dynamic | 35.000 | 2.000 | 1.000 |
| calibration_2018_2020 | optimized_base_only_ablation | 0.000 | 0.000 | 0.000 |
| strategy_conditional_holdout_2021 | optimized_dynamic | 12.000 | 1.000 | 0.000 |
| strategy_conditional_holdout_2021 | optimized_base_only_ablation | 0.000 | 0.000 | 0.000 |
...
- Formal assay results must return before next-day 09:00. If rapid C or the prior formal sediment result is late, use the flow component alone at the same threshold without waiting. A trigger adds samples on each of the next two calendar days, including across month and year boundaries.
...
| --- | --- | --- | --- | --- | --- |
| 2022 | 270.000 | 346.667 | 1825.000 | 527.000 | 34.219 |
| 2023 | 270.000 | 346.667 | 1825.000 | 735.000 | 52.834 |
| 2022-2023 total | 540.000 | 693.333 | 3650.000 | 1262.000 | 45.061 |
...
| --- | --- | --- | --- | --- | --- |
| assay_heavy | 1.000 | 4.000 | 693.333 | 2093.000 | 66.874 |
| balanced | 1.000 | 1.000 | 277.333 | 671.000 | 58.669 |
| visit_light | 2.000 | 1.000 | 416.000 | 868.000 | 52.074 |
| pre_specified | 4.000 | 1.000 | 693.333 | 1262.000 | 45.061 |
| visit_heavy | 8.000 | 1.000 | 1248.000 | 2050.000 | 39.122 |
